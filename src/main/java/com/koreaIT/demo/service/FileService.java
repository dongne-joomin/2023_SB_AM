...
public class FileService {
	...
	public void saveFile(MultipartFile file, String title, String report, String price) throws IOException {
		...
		fileRepository.insertFileInfo(title, report, orgName, savedName, savedPath, price);
