	...
	<div class="container mx-auto px-3 overflow-x-auto">
		<div class="mb-2 flex justify-between items-end">
			...
			<form>
				...
				<select data-value ="${searchKeywordType }" class="select select-bordered" name="searchKeywordType" size="1">
		...
		<div class=" mt-2 flex justify-center">
			<div class="btn-group">
				...
				<c:if test="${page > 1 }">
					...
					<a class="btn btn-sm"
						href="${pageBaseUri }&&page=${page - 1 }">&lt;</a>
				</c:if>
				...
				<c:if test="${page < pagesCount }">
					<a class="btn btn-sm"
						href="${pageBaseUri }&&page=${page + 1 }">&gt;</a>
					<a class="btn btn-sm"
						href="${pageBaseUri }&page=${pagesCount }">»</a>
				</c:if>
				<c:if test="${page == pagesCount }">
					<a class="btn btn-sm btn-disabled">&gt;</a>
					<a class="btn btn-sm btn-disabled">»</a>
